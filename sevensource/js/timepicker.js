...
//      url : www.sparrowscripts.com
	...
	function selectTime(ctl,ctl2,pl,pt) {
		var leftpos=pl;
		var toppos=pt;
		...
		aTag = ctl;
		leftpos += document.getElementById('DHTMLSuite_modalBox_contentDiv').offsetLeft ;
		toppos += document.getElementById('DHTMLSuite_modalBox_contentDiv').offsetTop;
		//do {
//			aTag = aTag.offsetParent;
//			leftpos	+= aTag.offsetLeft;
//			toppos += aTag.offsetTop;
//		} while(aTag.tagName!="BODY");
		crossobj.left =	leftpos  //ctl.offsetLeft	+ leftpos 
		crossobj.top = toppos  //ctl.offsetTop +	toppos + ctl.offsetHeight +	2 
