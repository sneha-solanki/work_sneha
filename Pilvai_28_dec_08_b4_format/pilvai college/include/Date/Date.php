 ...
 */
/*if (!defined('DATE_DIR')) {
    define('DATE_DIR', dirname(__FILE__) . DIRECTORY_SEPARATOR);
}

if (!defined('DATE_CORE_DIR')) {
    define('DATE_CORE_DIR', DATE_DIR . 'Date' . DIRECTORY_SEPARATOR);
}

require_once DATE_CORE_DIR.'TimeZone.php';
require_once DATE_CORE_DIR.'Calc.php';
require_once DATE_CORE_DIR.'Span.php';*/
/**@#-*/
